...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default=os.path.join("configs", "celeba.yml"),
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the target image path",
    )
    parser.add_argument(
        "--source_image_path",
        type=str,
        required=True,
        help="Path to the source image path",
    )
    parser.add_argument(
        "--image_size",
        type=tuple,
    ...
    parser.add_argument(
        ...
        type=tuple,
        default=(256, 256),
        help="input image size before segment (height, width)",
    )
    parser.add_argument(
        "--label_config",
        type=str,
        default=os.path.join("image_segmentation", "label.yml"),
        help="Path to the label.yml",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="erode mask before pass to SDEdit (1) or not (0)",
    )
    parser.add_argument(
        "--erode_kernel_size", type=int, default=7, help="erode kernel size"
    )
...
def main():
    ...
    cv2.imwrite(
        "report_images/transformed_mask.png",
        cv2.cvtColor(transformed_mask, cv2.COLOR_RGB2BGR),
    )
